            ...
            <div class="card table-card">
                <div class="card-header">
                    <div class="sm:flex items-center justify-between">
                        ...
                        <div>
                            <a href="{{ route(\Illuminate\Support\Facades\Auth::user()->roles->first()->name.'.managers.create') }}" class="btn btn-primary">Create Manager</a>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-hover" id="pc-dt-simple">
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route(\Illuminate\Support\Facades\Auth::user()->roles->first()->name.".managers.edit", $user->roleable->id) }}" class="w-8 h-8 rounded-xl inline-flex items-center justify-center btn-link-secondary">
