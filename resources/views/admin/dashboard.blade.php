        ...
        <div class="card">
            <div class="card-body">
                <div class="flex items-center">
                    ...
                    <div class="grow ltr:ml-3 rtl:mr-3">
                        <p class="mb-1">Attorneys</p>
                        <div class="flex items-center justify-between">
                            <h4 class="mb-0">{{ $stats['attorneys'] }}</h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <ul class="rounded-lg *:py-4 divide-y divide-inherit border-theme-border dark:border-themedark-border">
                    ...
                    <li class="list-group-item">
                        <div class="flex items-center">
                            ...
                            <div class="shrink-0">
                                <a href="{{ route('admin.tickets.edit', $pendingTicket->id) }}" class="w-8 h-8 rounded-xl inline-flex items-center justify-center btn-light-secondary">
