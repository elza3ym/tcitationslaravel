            ...
            <div class="card table-card">
                <div class="card-header">
                    <div class="sm:flex items-center justify-between">
                        ...
                        <div>
                            <a href="{{ route('driver.tickets.export') }}" class="btn btn-success"><span class="fa fa-file-excel mr-2"></span>Download Tickets</a>
                        ...
                        <table class="table table-hover" id="pc-dt-simple">
                            ...
                            @foreach($tickets as $ticket)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('driver.tickets.show', $ticket->id) }}" class="w-8 h-8 rounded-xl inline-flex items-center justify-center btn-link-secondary">
